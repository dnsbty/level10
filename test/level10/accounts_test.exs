defmodule Level10.AccountsTest do
  use Level10.DataCase

  alias Level10.Accounts
  import Level10.AccountsFixtures
  alias Level10.Accounts.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "validates email and password when given" do
      {:error, changeset} = Accounts.register_user(%{email: "invalid", password: "inv4l!d"})
  ...
  describe "change_user_password/2" do
    ...
    test "allows fields to be set" do
      ...
      assert changeset.valid?
      assert get_change(changeset, :password) == "new valid p4$$word"
      assert is_nil(get_change(changeset, :hashed_password))
    end
  end
  ...
  describe "reset_user_password/2" do
    ...
    test "updates the password", %{user: user} do
      {:ok, updated_user} = Accounts.reset_user_password(user, %{password: "new valid p4$$word"})
