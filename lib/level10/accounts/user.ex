defmodule Level10.Accounts.User do
  @moduledoc """
  Every player in every game should be a registered user. This schema is
  responsible for those users, and stores their credentials for logging in.
  """
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Level10.Repo)
  ...
  """
  def valid_password?(%Level10.Accounts.User{hashed_password: hashed_password}, password)
